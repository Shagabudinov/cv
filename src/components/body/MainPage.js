    ...
    >
      <div className='home-content'>
        ...
        <div className='btn-box'>
          <a href={CVru} target='_blank' rel='noreferrer' className='btn'>
            CV [preview]
          </a>
        ...
        <div className='home-content__media'>
          <a href='https://vk.com/st3lfy' target='_blank' rel='noreferrer'>
            <i className='bx bxl-vk'></i>
          </a>
          <a href='https://t.me/St3lfy' target='_blank' rel='noreferrer'>
            <i className='bx bxl-telegram'></i>
          </a>
          <a
            href='https://github.com/Shagabudinov'
            target='_blank'
            rel='noreferrer'
          >
